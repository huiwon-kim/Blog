...
/* 	SELECT 
	...
	String updateSql = "SELECT board_no boardNo, board_title boardTitle, board_content boardContent, board_pw boardPw FROM board WHERE board_no=?";
	//SELECT board_no boardNo, board_title boardTitle, board_content boardContent FROM board WHERE board_no=?
	PreparedStatement updateStmt = conn.prepareStatement(updateSql);
	updateStmt.setInt(1, boardNo);
	System.out.println(updateStmt);
	ResultSet boardrs =updateStmt.executeQuery();
	  	...
	  	<form action="./updateBoardAction.jsp" method="post">
		  	...
		  	<tr>
		  		...
		  		<tr>
		  			<td> BoardContent</td>
		  			<td> 
		  				<textarea rows="5" cols="80" name="boardContent"> <%=boardrs.getString("boardContent")%></textarea>		  			
		  			</td>
		  		</tr>
		  			<tr>
		  			<td> BoardPw</td>
